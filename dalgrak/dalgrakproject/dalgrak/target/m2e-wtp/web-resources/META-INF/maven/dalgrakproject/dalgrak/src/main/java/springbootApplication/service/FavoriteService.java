...
public class FavoriteService {
    ...
    public Favorite addFavorite(Favorite favorite) {
        ...
        List<Subscription> subscribers = subscriptionRepository.findByRecipeId(favorite.getRecipeId().getRecipeId());
        for (Subscription subscriber : subscribers) {
            String message = favorite.getUserId().getUsername() + "님이 즐겨찾기에 추가했습니다.";
