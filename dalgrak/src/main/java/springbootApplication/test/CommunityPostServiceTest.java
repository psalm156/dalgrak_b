...
public class CommunityPostServiceTest {
 ...
 // 게시물 제목으로 검색 테스트
    ...
    void getPostsByTitle_Success() {
        ...
        // 실제 메서드 실행
        Optional<List<CommunityPost>> posts = communityPostService.getPostsByTitle("Test");
    ...
    void getPostsByTitle_NoPosts() {
        ...
        // 실제 메서드 실행
        Optional<List<CommunityPost>> posts = communityPostService.getPostsByTitle("NonExistent");

        // 결과 확인
        assertFalse(posts.isPresent());  // Optional이 비어 있음을 확인
    }
